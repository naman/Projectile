...
htmlhelp_basename = 'Projectiledoc'
...
latex_documents = [
  (master_doc, 'Projectile.tex', u'Projectile Documentation',
   u'Naman Gupta', 'manual'),
]
...
man_pages = [
    (master_doc, 'projectile', u'Projectile Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Projectile', u'Projectile Documentation',
   author, 'Projectile', 'One line description of project.',
   'Miscellaneous'),
]
